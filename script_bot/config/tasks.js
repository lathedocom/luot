...
module.exports = {
   ...
   // ==========================================
    ...
    MATCH_TIMELINE: {
        model: models.LAYER2_MODEL_PRIMARY, // ĐÃ SỬA: Gọi biến cấu hình thay vì text cứng
        temperature: 0.1, 
        max_tokens: 150,
...
Hãy trả về ĐÚNG cấu trúc JSON sau (không kèm text khác):
{
  ...
  "reason": "Lý do ngắn gọn dưới 20 chữ"
    ...
    SHORT_SUMMARY: {
        model: models.LAYER1_MODEL_PRIMARY, // ĐÃ SỬA
        temperature: 0.3,
...
Nội dung: ${data.content}`
    ...
    DEEP_ANALYSIS: {
        model: models.LAYER2_MODEL_PRIMARY, // ĐÃ SỬA
        temperature: 0.3,
