module.exports = {
    ...
    SYMBOLS: [
        ...
        // --- TIỀN SỐ (Binance) ---
        { id: 'BTC', name: 'Bitcoin', type: 'crypto', threshold: 0.0, api_source: 'coingecko', api_symbol: 'bitcoin', keywords: ['bitcoin', 'btc', 'tiền ảo', 'tiền mã hóa'] },
        { id: 'ETH', name: 'Ethereum', type: 'crypto', threshold: 0.0, api_source: 'coingecko', api_symbol: 'ethereum', keywords: ['ethereum', 'eth'] },
