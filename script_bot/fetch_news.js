...
{ "is_same_event": true/false }`;
            ...
            // --- 🛡️ LỚP PHÒNG THỦ D: LỌC THEO LĨNH VỰC QUAN TÂM (Rule Engine, miễn phí) ---
            ...
            if (matchedPriority.length === 0) {
                ...
                continue; // Không gọi AI, bỏ qua cụm này
            }

            // --- 🛡️ LỚP PHÒNG THỦ E: LỌC THEO ĐỘ QUAN TRỌNG (Importance Rule-based, miễn phí) ---
            ...
            if (ruleImportance < 50) { // Ngưỡng 50 điểm
